 ...
 */
package ch.psi.importerFDA;

import ch.psi.fda.model.ModelManager;
import ch.psi.fda.model.v1.*;
 ...
 * 
 */
public class ImporterFDA implements Importer{
    ...
    public void main(String[] args) throws Exception {
        ...
        String script = new ImporterFDA().importFile(new File(fileName));
